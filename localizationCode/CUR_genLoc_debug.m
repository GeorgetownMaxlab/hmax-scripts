function CUR_genLoc_debug(nPatchesAnalyzed,nPatchesPerLoop,startingPatchLoopIdx)
...
for iTask = 3:numel(tasks)
    ...
    condition = 'annulusExptFixedContrast/simulation2/set1/';
    saveLoc   = fullfile(home,condition,'data',tasks{iTask},'lfwSingle50000','fixedLocalization','sandbox');
    loadLoc   = fullfile(home,condition,'data',tasks{iTask},'lfwSingle50000');
