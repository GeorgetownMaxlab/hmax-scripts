function CUR_findScaledTriplets(nTPatchesLoad,nCPatchesLoad,nTPatches,nCPatches)
...
loadFolder = ['simulation1/training/data/patchSetAdam/lfwSingle50000/scaling/doublets/' int2str(nTPatchesLoad) 'TPatches' int2str(nCPatchesLoad) 'CPatches'];
saveFolder = ['simulation1/training/data/patchSetAdam/lfwSingle50000/scaling/doublets/' ...
...
if ispc == 1
    ...
    singlesLoc = 'C:\Users\Levan\HMAX\annulusExptFixedContrast\simulation1/training/data/patchSetAdam/lfwSingle50000/';
else    
    loadLoc    = ['/home/levan/HMAX/annulusExptFixedContrast/' loadFolder '/'];
    saveLoc    = ['/home/levan/HMAX/annulusExptFixedContrast/' saveFolder '/'];
    singlesLoc = '/home/levan/HMAX/annulusExptFixedContrast/simulation1/training/data/patchSetAdam/lfwSingle50000/';
end
...
singlesImgHitsWedge = load([singlesLoc 'imgHitsWedge.mat']);
...
CUR_make_scaledTriplet_c2_imgHits(singlesLoc,saveLoc,nTPatches,nCPatches,pushValue)
runTime = toc
