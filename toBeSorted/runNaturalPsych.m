function c2 = runNaturalPsych(locationFileToLoad, loadFolder, saveFolder, quadType, nPatchesAnalyzed, COMBINATION, BLUR, keepS2)
...
if ispc == 1 
    ...
    patchesLoc      = ('C:\Users\Levan\HMAX\patches\LFWeyes2\')
    emptyImgLoc = ('C:\Users\Levan\HMAX\naturalFaceImages\naturalFaceImages2\');
else
    loadLoc         = '/home/levan/HMAX/naturalFaceImages/trainingTestingArrays/' 
    saveLoc         = ['/home/levan/HMAX/naturalFaceImages/' saveFolder '/']
    patchesLoc      = ('/home/levan/HMAX/patches/LFWeyes2/')
...
%% matlab implementation to create C2    
    if strcmp(quadType,'f') == 1
        ...
        for i = 1:length(facesLoc)
            [c2f, ~, bestBands, bestLoc, s2f] = genC2(gaborSpecs, facesLoc{i}, c1bands, patch, patches.sizes, 1, 0, COMBINATION, BLUR, keepS2);
        ...
        for i = 1:length(emptyLoc)
            [c2e, ~, bestBands, bestLoc, s2e] = genC2(gaborSpecs, emptyLoc{i}, c1bands, patch, patches.sizes, 1, 0, COMBINATION, BLUR, keepS2);
