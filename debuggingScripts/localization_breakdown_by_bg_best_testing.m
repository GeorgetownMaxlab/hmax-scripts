...
mean_per_bg_trainig_minus_part2up = mean_per_bg_training(1:20)-mean_per_bg_part2up;
mean_per_bg_trainig_minus_part2up = [mean_per_bg_trainig_minus_part2up 0 0 mean(mean_per_bg_trainig_minus_part2up)];
bar(mean_per_bg_trainig_minus_part2up,'FaceColor',bar_color)
hold on
% for iBg = 1:length(unique_bgs_part2up)
%     scatter(ones(1,length(sum_per_bg_instance_training{iBg}))*iBg,...
%             sum_per_bg_instance_training{iBg}-sum_per_bg_instance_part2up{iBg},...
%             markerSize,...
%             'MarkerEdgeColor','k',...
%             'MarkerFaceColor','r');
% %     boxplot(sum_per_bg_instance_testing{iBg})
...
suptitle('Broken down by Backgrounds')
% pause