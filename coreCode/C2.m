function [c2,s2,c1,s1,bestBand,bestLocations] = C2(img,filters,filterSizes,c1Space,c1Scale,c1OL,linearPatches,patchSize,c1,...
...
% See also C1 (C1.m)
    ...
    if (nargin <  9 || isempty(c1)) [c1,~] = C1(img,filters,filterSizes,c1Space,c1Scale,c1OL,0); end;
...
% 					nRows = nRows - 7;
% 					nCols = nCols - 7;
% 					ignoreBorders = s2{iPatch}{iBand}(3:size(s2{iPatch}{iBand}, 1) - 5, 3:size(s2{iPatch}{iBand}, 2) - 5);	
