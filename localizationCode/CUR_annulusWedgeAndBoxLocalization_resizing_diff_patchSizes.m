function CUR_annulusWedgeAndBoxLocalization_resizing_diff_patchSizes(...
                    nPatches, patchSizes, loadFolder, condition, ...
                    saveFolder, runImgDiff, maxSize,...
                    facesFileToLoad, quadType)
...
if(nargin < 8) facesFileToLoad = 'facesLoc.mat';
end
if(nargin < 7) maxSize = 579;
end
if(nargin < 6) runImgDiff = 1;
end
...
scalingFactor = zeros(1,length(facesLoc{1}));
...
%         fprintf('STARTING W CUSTOM IMAGE!!')
        ...
        y1   = bestLoc(iPatch, iImg, 1); % y1 is the ROW    coordinate of top-left corner.
        y1   = y1 - rows_shift_topLeft;   
        
        x1   = bestLoc(iPatch, iImg, 2); % x1 is the COLUMN coordinate of the top-left corner.
