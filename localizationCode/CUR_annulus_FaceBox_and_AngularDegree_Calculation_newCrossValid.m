function CUR_annulus_FaceBox_and_AngularDegree_Calculation_newCrossValid(...
                    iPatchLoop,...
                    nPatchesPerLoop,...
                    patchSizes,...
                    loadLoc,...
...
% with the new cross validation sets that are combinations of images from
% different sets, the above method of getting the img# won't work. But it
% should be fine to treat iImg as just the index within facesLoc file, as
% opposed to the actual number on the image. Those numbers get repeated
% too! Becase these are combinations of images from various sets.
imgFacesLoc = 1:length(facesLoc{1});
