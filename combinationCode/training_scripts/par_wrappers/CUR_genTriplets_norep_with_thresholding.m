function CUR_genTriplets_norep_with_thresholding(nTPatchesLoad,nCPatchesLoad,nTPatches,nTPatchesPerLoop,nCPatches,condition,CPatchThreshold)
...
% threshold
load(fullfile(singlesLoc,'patchPerformanceInfo_Wedge_30.mat'));
...
%     iPatchLoop
    CUR_findScaledTriplets_Wedge30_par_with_threshold(...
        iPatchLoop,...
        nTPatchesPerLoop,...
        nCPatches,...
        saveLoc,...
