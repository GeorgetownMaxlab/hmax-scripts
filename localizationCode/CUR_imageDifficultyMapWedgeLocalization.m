function sortSumStatsPatch = CUR_imageDifficultyMapWedgeLocalization(...
    patchType,quadType,...
...
load(fullfile(loadPath,'imgHitsWedge'));
...
save(fullfile(loadPath,['imageDifficultyData_Wedge_' num2str(patchesShown) '_Patches']),'-v7.3');
