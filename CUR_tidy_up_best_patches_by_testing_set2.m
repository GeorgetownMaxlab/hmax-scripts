...
% NOTE THAT VARIABLE NAMES ARE FLIPPED: WHATEVER HAS "TRAINING" IN THE NAME
% ACTUALLY IS "TESTING" DATA, AND VICE-VERSA.
% SO THIS SCRIPT DOES EVERYTHING THE SAME BUT LOADS THE TESTING/TRAINING 
% IN A FLIPPED WAY.
