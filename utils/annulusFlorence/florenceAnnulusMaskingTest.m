...
% Here I've saved all variables in workspace and will just load them for
% speed.
load('C:\Users\Levan\HMAX\scripts\utils\annulusFlorence\sandbox\data');

%% Mask each background through this annulus and save the results in a folder with the backgrounds used in this experiment
% indeximage=1;    
% [nomDir, NomFichierMat] = LookForFiles('AllBackgrounds/');% liste tous les (list all)
...
%         eval(['imread ' nomf]);
%         bgtomask = ans;
        bgtomask = imread('C:\Users\Levan\HMAX\annulusExpt\Images_Faces_Backgrounds\AllBackgrounds\1.jpg');
