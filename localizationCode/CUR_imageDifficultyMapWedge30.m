function sortSumStatsPatch = CUR_imageDifficultyMapWedge30(...
    patchType,quadType,...
    loadLoc, makePlot, patchesShown)

% This code analyzes the imgHitsWedge file and outputs data about which
...
load(fullfile(loadLoc,'imgHitsWedge'));
...
clearvars imgHitsWedge
save(fullfile(loadLoc,['imageDifficultyData_Wedge_' num2str(patchesShown) '_Patches']),'-v7.3');
