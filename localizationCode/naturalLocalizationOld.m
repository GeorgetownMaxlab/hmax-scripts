function hits = naturalLocalizationOld(nPatches, saveFolder, type, nQuad, patchSize)
%
...
%
if(nargin < 5) patchSize = 2 
end
if(nargin < 4) nQuad = 4
end
if(nargin < 3) type = 'f'
end
home = ['/home/bentrans/Documents/HMAX/feature-learning/HMAX-MATLAB/naturalFaceImages2/'...
       saveFolder '/']
dbstop if error;
load([home 'facesLoc.mat']); %variable in workspace called 'facesLoc'
