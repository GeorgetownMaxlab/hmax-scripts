function patchImageExtractionTest(nPatches, patchesFolder, saveFolder, patchName, imgResize, c1Scale, c1Space, rfSizes, ext)
...
% load('C:\Users\Levan\HMAX\naturalFaceImages\testingSetRuns\patchSet2\lfwDouble100\hardImageLocalizationData.mat',...
%     'IndHardImgPatches','sortSumStatsPatch')
index = IndPatch(1:nPatches);
...
for i = 1:length(coordinates)
	...
	imwrite(croppedImg, [saveLoc 'topPatches\patch' int2str(i) '-'...
        num2str(sortSumStatsPatch(i)) '%.' ext], ext);
