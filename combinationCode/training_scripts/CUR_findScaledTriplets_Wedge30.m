function CUR_findScaledTriplets_Wedge30(nTPatchesLoad,nCPatchesLoad,nTPatches,nCPatches)
...
loadLoc = fullfile(home,condition,'data','acrossPatchTypes','lfwSingle50000','scaling_WedgeDegree_30','doublets',...
                   [int2str(nTPatchesLoad) 'TPatches' int2str(nCPatchesLoad) 'CPatches'],'sandbox');
               
saveLoc = fullfile(loadLoc,'triplets',[int2str(nTPatches) 'TPatches' int2str(nCPatches) 'CPatches'],'sandbox2');

% loadFolder = ['simulation1/testing/data/patchSetAdam/lfwSingle50000/scaling_FaceBox_switchSets/doublets/' ...
...
singlesLoc = fullfile(home,condition,'data','acrossPatchTypes','lfwSingle50000','fixedLocalization');
