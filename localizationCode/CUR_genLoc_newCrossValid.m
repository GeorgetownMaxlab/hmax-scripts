function CUR_genLoc_newCrossValid(condition,nPatchesAnalyzed,nPatchesPerLoop,startingPatchLoopIdx)
...
if (nargin < 1)
    condition = 'annulusExptFixedContrast/simulation3/testing3/';
end
...
%             display('Parfor is Off!!!!');
        ...
        CUR_annulus_FaceBox_and_AngularDegree_Calculation_newCrossValid(...
            iPatchLoop,...
            nPatchesPerLoop,...
            currentPatchSizes,...
            loadLoc,...
